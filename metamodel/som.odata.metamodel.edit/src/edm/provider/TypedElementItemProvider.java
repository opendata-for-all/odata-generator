...
/**
 * This is the item provider adapter for a {@link edm.TypedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypedElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EdmPackage.Literals.TYPED_ELEMENT__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMultivaluedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypedElement_multivalued_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypedElement_multivalued_feature", "_UI_TypedElement_type"),
				 EdmPackage.Literals.TYPED_ELEMENT__MULTIVALUED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Boolean labelValue = ((TypedElement)object).getMultivalued();
